<!-- pages/guides/posesion-efectiva-chile.vue -->
<template>
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="bg-white border-b">
        <div class="max-w-4xl mx-auto px-4 py-3">
          <div class="flex items-center text-sm">
            <NuxtLink to="/guides" class="text-gray-500 hover:text-primary-600">Guías</NuxtLink>
            <ChevronRight class="w-4 h-4 mx-2 text-gray-400" />
            <span class="text-gray-700">Posesión Efectiva en Chile</span>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-4xl mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-6">Guía Completa para la Posesión Efectiva en Chile</h1>
        ...
        <!-- Guide sections -->
        <div class="space-y-6">
          <div v-for="(section, index) in sections" :key="index" :id="section.id" class="bg-white rounded-lg shadow-sm border overflow-hidden">
            ...
            <div 
              v-show="section.isOpen || section.id === 'que-es'"
              class="px-6 py-4 border-t"
            >
              <div class="prose prose-slate prose-ul:list-disc prose-ul:pl-5 max-w-none" v-html="section.content"></div>
            </div>
          </div>
        </div>
        ...
        <div class="mt-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white border p-4 rounded-lg opacity-50">
              <h3 class="font-medium">Trámites de Herencia en Chile</h3>
              <p class="text-gray-600 text-sm">Próximamente</p>
            </div>
            <div class="bg-white border p-4 rounded-lg opacity-50">
              <h3 class="font-medium">Testamentos: Guía Práctica</h3>
              <p class="text-gray-600 text-sm">Próximamente</p>
            </div>
          </div>
        </div>
